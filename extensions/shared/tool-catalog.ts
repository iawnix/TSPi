export const TS_PUBLIC_TOOL_NAMES = Object.freeze({
  ...
  structureSeed: "ts_structure_seed",
  structureCompare: "ts_structure_compare",
  artifactImport: "ts_artifact_import",
  render: "ts_render",
  report: "ts_report",
...
export const TS_PUBLIC_TOOL_EXECUTION = Object.freeze({
  ...
  [TS_PUBLIC_TOOL_NAMES.structureSeed]: "deterministic_artifact",
  [TS_PUBLIC_TOOL_NAMES.structureCompare]: "deterministic_artifact",
  [TS_PUBLIC_TOOL_NAMES.artifactImport]: "deterministic_artifact",
