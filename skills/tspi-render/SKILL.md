---
name: tspi-render
description: Produce deterministic visual artifacts from registered TSPi structures for inspection, comparison, animation, and mechanism presentation.
---
...
- Keep the owning ResearchNode, logical artifact IDs, output name, and selected
  operation explicit.
- Treat `render`, `animate`, `compare`, and `mechanism` as separate operations
