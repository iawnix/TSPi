...
Resolve input IDs with `research_read mode=artifacts`, choose the owning Node and a
safe output name, run `artifact_render`, and inspect the returned Artifact and digest.
