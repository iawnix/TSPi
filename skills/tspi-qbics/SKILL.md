...
First query `research_read mode=capabilities capabilityKind=compute`. Proceed only
...
`compute_run` request, run arbitrary shell, or present QBICS as executable through
TSPi.
