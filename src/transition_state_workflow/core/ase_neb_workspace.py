"""ASE NEB workspace persistence: tree state, evidence, node records, scaffold.
...
``nodes/``, and the node-record builder used by ASE NEB orchestration. Pure I/O
and schema bookkeeping; no ASE runtime and no result generation.
"""
...
def append_evidence_record(
    ...
    *,
    ...
    """Append or update one v2 evidence-registry record for an ASE NEB tool."""
