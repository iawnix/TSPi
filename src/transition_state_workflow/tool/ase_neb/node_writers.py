"""Write the main-path workspace nodes for a NEB run.
...
from transition_state_workflow.tools.ase_neb.config import ProjectContext, level_slug_from_calculator
...
def write_input_check_node(
    ...
    mechanism_preflight = infer_mechanism_preflight(cfg, reactant, product)
...
__all__ = ["write_input_check_node", "write_neb_node_metadata"]
