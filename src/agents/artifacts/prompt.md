...
- Email draft payload: `operation`, `template_id`, `summary_ref`, `summary_digest`, `manifest_ref`, `manifest_digest`, `source_workspace_revision`, `draft_ref`, `recipients`, `subject`.
