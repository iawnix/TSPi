...
The activity journal is the authoritative record of Compute, Render, and Report
execution.  ResearchAct documents do not duplicate these relationships.
"""
...
ACTIVITY_KINDS = frozenset({"compute", "render", "report"})
