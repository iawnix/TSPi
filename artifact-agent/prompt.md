...
- Report payload: `operation`, `package_ref`, `report_ref`, `context_ref`, `email_summary_ref`, `assets_ref`.
- Email draft payload: `operation`, `summary_ref`, `draft_ref`, `recipients`, `subject`.
