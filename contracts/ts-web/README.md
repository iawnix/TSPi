...
TSPi owns the read-only projection provider. An optional `ts-web` client may
consume the snapshot and graph payloads without importing TSPi Python modules.
