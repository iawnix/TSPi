...
sys.path.insert(0, str(Path(__file__).resolve().parents[1] / "packages/ts-agent-kernel"))
from tests.workspace_helpers import bootstrap_workspace_fixture, start_research_node
from tests.test_scientific_analysis import gaussian_log, barrier, reaction, source
