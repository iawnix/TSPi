...
def test_review_aggregator_preserves_failure_and_reports_disagreement() -> None:
    result = node_json(
        ...
        "inputs:{review_snapshot:{ref:'review-snapshot.json',schema_version:'ts-review-task-snapshot/4',sha256:'sha256:'+'a'.repeat(64),bytes:1},provider_input:{ref:'provider-input.json',schema_version:'ts-review-provider-input/6',sha256:'sha256:'+'b'.repeat(64),bytes:1}},"
