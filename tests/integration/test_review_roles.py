...
def test_review_aggregator_preserves_failure_and_reports_disagreement() -> None:
    result = node_json(
        ...
        "inputs:{research_map:{ref:'research-map.json',schema_version:'research-map/1',sha256:'sha256:'+'a'.repeat(64),bytes:1},review_context:{ref:'review-context.json',schema_version:'ts-review-context/1',sha256:'sha256:'+'b'.repeat(64),bytes:1}},"
