...
REQUIRED_TARBALL_FILES = {
    ...
    "extensions/shared/subagent-tool-presentation.ts",
    "extensions/ts-phone-policy/index.ts",
    ...
    "src/agents/compute/policy-loader.cjs",
    "src/agents/compute/policy.md",
    "src/agents/compute/backends/gaussian.md",
