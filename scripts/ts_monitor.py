...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        if args.command == "list":
            result = {"schema_version": "ts-compute-monitor-list/1", "monitors": list_monitors(args.root)}
            ...
            result = claim_delivery(args.root, args.event_id)
