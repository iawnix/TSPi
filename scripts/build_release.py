...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(prefix="ts-agent-pack-") as temporary:
            ...
            wheel_descriptor = build_wheel(source_root, wheel_dir)
            ...
            source_digest = source_payload_sha256(source_root)
            ...
            seed_pack_dir.mkdir()
            seed_archive = npm_pack(source_root, seed_pack_dir, cache_dir)
        ...
        manifest = {
            ...
            "source": {"git_commit": captured.git_commit, "dirty": captured.dirty},
