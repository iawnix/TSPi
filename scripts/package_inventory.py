...
APP_SERVER_FILES = [
    ...
    "apps/app-server/tspi-host.mjs",
    "apps/app-server/tspi-host-client.mjs",
    "apps/app-server/tspi-terminal-client.mjs",
    "apps/app-server/tspi-terminal-errors.mjs",
    "apps/app-server/tspi-terminal-runtime.mjs",
    "apps/app-server/tspi-browser-gateway.mjs",
    "apps/app-server/tspi-history.mjs",
    "apps/app-server/pi-harness-policy.mjs",
    "apps/app-server/tspi-harness-backend.mjs",
    "apps/app-server/tspi-native-client-facet.mjs",
    "apps/app-server/native-client-env.mjs",
    "apps/app-server/tspi-receipts.mjs",
    "apps/app-server/tspi-scheduler-lease.mjs",
...
PACKAGE_FILES = [
    ...
    "config/pi-harness-admission.patch",
    "config/pi-harness-admission-queue.patch",
    "config/pi-harness-operation-request.patch",
    "config/pi-harness-operation-forward.patch",
    "config/pi-tool-error-boundary.patch",
    "config/pi-tool-error-boundary-repair.patch",
    "config/pi-build-json-compat.patch",
    "config/pi-transcript-json.patch",
    "config/pi-session-navigation.patch",
    *CONTRACT_FILES,
    "environment.yml",
    ...
    "extensions/pi/ui/*.ts",
    "extensions/pi/tui-package/package.json",
    "extensions/pi/tui-package/src/*",
    ...
    "packages/ts-agent-kernel/ts_agent/pyscf/*.py",
...
REQUIRED_TARBALL_FILES = frozenset(
    {
        ...
        *SKILL_ENTRY_FILES,
        ...
        "extensions/pi/shared/ref-presentation.ts",
        "extensions/pi/shared/artifact-tool-presentation.ts",
        "extensions/pi/shared/native-tool-presentation.ts",
        ...
        "extensions/pi/tui-package/package.json",
        "extensions/pi/tui-package/src/editor.ts",
        "extensions/pi/tui-package/src/tui.ts",
        "extensions/pi/tui-package/src/header.ts",
        "extensions/pi/tui-package/src/runs.ts",
        "extensions/pi/tui-package/src/document-viewer.ts",
        "extensions/pi/tui-package/src/pi-experimental.d.ts",
        ...
        *APP_SERVER_FILES,
        ...
        "packages/ts-agent-kernel/ts_agent/backends/pyscf.py",
        "packages/ts-agent-kernel/ts_agent/backends/pyscf_runner.py",
        "packages/ts-agent-kernel/ts_agent/pyscf/__init__.py",
        "packages/ts-agent-kernel/ts_agent/pyscf/runner.py",
        ...
        "docs/adr/0005-ordinary-pi-host-bridge.md",
    }
)
